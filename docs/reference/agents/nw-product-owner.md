...
- [outcome-kpi-framework](../../../nWave/skills/product-owner/outcome-kpi-framework.md) — Outcome KPI definition methodology - synthesizes Who Does What By How Much (Gothelf/Seiden), Running Lean (Maurya), and Measure What Matters (Doerr) into a practical framework for measurable outcome KPIs
...
- [user-story-mapping](../../../nWave/skills/product-owner/user-story-mapping.md) — User story mapping for backlog management and outcome-based prioritization. Load during Phase 2.5 (User Story Mapping) to produce story-map.md and prioritization.md.
