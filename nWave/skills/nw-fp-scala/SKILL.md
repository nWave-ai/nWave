...
**Frameworks**: ScalaCheck (PBT) | ZIO Test (integrated PBT + unit) | ScalaTest (BDD) | MUnit (lightweight). See [property-based-testing](../nw-property-based-testing/SKILL.md) for detailed PBT patterns.
