...
description: "Structured persona creation and JTBD analysis with ODI job steps, pain point mapping, and success metrics. Load when building user personas, mapping jobs-to-be-done, or segmenting user types."
