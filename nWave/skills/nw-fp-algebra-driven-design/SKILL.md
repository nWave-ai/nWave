...
description: "Algebra-driven API design with monoids, semigroups, and interpreters. Load when designing composable APIs, deriving laws from algebraic equations, or building interpreter patterns in FP."
